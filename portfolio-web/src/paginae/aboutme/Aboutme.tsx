...
export const AboutMe = () => {
  const [imageSection, setImageSection] = useState("/images/me/helena2.jpg");
  
  const textContainerRef = useRef(null);

  return (
    <section className="font-dmsans text-black pt-32 md:pt-24 pb-16 h-auto w-full flex flex-col justify-center items-center text-left px-6 md:px-12">
      <div className="flex flex-col md:flex-row justify-center items-center gap-8 md:gap-16 w-full max-w-6xl mx-auto">
        ...
        <div className="w-full md:w-1/3 flex justify-center self-stretch order-2">
          <img 
            src={imageSection}
            className="w-full max-w-xs md:max-w-sm lg:max-w-md rounded-lg shadow-lg transition-all duration-300 hover:scale-105"
      ...
      <div ref={textContainerRef} className="pt-30 w-full max-w-6xl mx-auto space-y-12 text-left px-2 md:px-12 order-2 md:order-1 lg:ml-20">

        {/* STUDIES */}
        <div>
          <h2 className="text-3xl md:text-4xl font-bold">Studies</h2>
        ...
        {/* STRENGTHS */}
        <div>
          <h2 className="text-3xl md:text-4xl font-bold">Strengths</h2>
          <p className="font-montserrat text-xl md:text-2xl mt-4">
        ...
        {/* BANDA ROSA TEXTO */}
        <div className="w-full bg-[var(--color-pink)] text-white font-black py-12 mt-16 rounded-2xl">
